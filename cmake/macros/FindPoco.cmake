...
FIND_LIBRARY(LIB_MONGODB_RELEASE
  NAMES
    PocoDataMySQL${POCO_LIBRARIES_EXT} ${LIB_MONGODB} 
  PATHS
    ${POCO_LIBRARIES_DIR}
)

FIND_LIBRARY(LIB_MONGODB_DEBUG
  NAMES
    PocoDataMySQL${POCO_LIBRARIES_EXT}d ${LIB_MONGODB}  
  PATHS
    ${POCO_LIBRARIES_DIR}
)
...
IF ( UNIX )
    ...
    if( CMAKE_CONFIGURATION_TYPES OR CMAKE_BUILD_TYPE )
      set( POCO_LIBRARIES
        optimized ${LIB_DATA_RELEASE} optimized ${LIB_DATA_MYSQL_RELEASE} optimized ${LIB_MONGODB_RELEASE} optimized ${LIB_FOUNDATION_RELEASE} optimized ${LIB_NET_RELEASE} optimized ${LIB_XML_RELEASE}
        debug ${LIB_DATA_DEBUG} debug ${LIB_DATA_MYSQL_DEBUG} debug ${LIB_MONGODB_RELEASE} debug ${LIB_FOUNDATION_DEBUG} debug ${LIB_NET_DEBUG} debug ${LIB_XML_DEBUG}
      )
    else()
      set( POCO_LIBRARIES
        ${LIB_DATA_RELEASE} 
...
MARK_AS_ADVANCED(LIB_MONGODB_RELEASE)
...
MARK_AS_ADVANCED(LIB_MONGODB_DEBUG)
